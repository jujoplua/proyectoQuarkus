...
public class ConsulRegister {
    ...
    @ConfigProperty(name = "quarkus.http.port", defaultValue = "8203") int msPort;
    @ConfigProperty(name = "quarkus.application.name", defaultValue = "ms-prestamos") String msName;
    ...
    public void init(@Observes StartupEvent ev, Vertx vertx) {
        ...
        if (msName == null || msName.isBlank()) {
            msName = "ms-prestamos"; // Fallback en caso de error
        }
