...
public class ConsulRegister {
    ...
    @ConfigProperty(name = "quarkus.http.port", defaultValue = "8202") int msPort;
    @ConfigProperty(name = "quarkus.application.name", defaultValue = "ms-libros") String msName;
    ...
    public void init(@Observes StartupEvent ev, Vertx vertx) {
        ...
        if (msName == null || msName.isBlank()) {
            msName = "ms-libros"; // Fallback en caso de error
        }
